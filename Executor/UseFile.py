'''
Class that allows to execute macro in excel file
method OpenFile opens excel file
method CloseFile closes excel file
methods ClickMassCalc, ClickSumOil and ClickSumBushes executes corresponding macro's
'''
